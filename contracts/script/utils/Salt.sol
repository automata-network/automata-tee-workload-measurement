...
bytes32 constant CVM_VERIFIER_PROXY_SALT = keccak256(bytes("CVM_VERIFIER_PROXY_SALT"));
bytes32 constant CVM_VERIFIER_IMPL_SALT = keccak256(bytes("CVM_VERIFIER_IMPL_SALT"));