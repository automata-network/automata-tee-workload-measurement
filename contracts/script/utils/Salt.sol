...
bytes32 constant TPM_ATTESTATION_PROXY_SALT = keccak256(bytes("TPM_ATTESTATION_PROXY_SALT"));
bytes32 constant TPM_ATTESTATION_IMPL_SALT = keccak256(bytes("TPM_ATTESTATION_IMPL_SALT"));
